...
export default function PublicFooter() {
  ...
  const footerLinks = [
    ...
    { label: t("dataSecurity"), href: "/data-security" as const },
    { label: t("faq"), href: "/faq" as const },
    { label: t("privacyPolicy"), href: "/privacy-policy" as const },
    { label: t("termsConditions"), href: "/terms" as const },
  ];

  const serviceLinks = [
    { label: t("dedicatedTeams"), href: "/services/dedicated-teams" as const },
    { label: t("onDemandSupport"), href: "/services/on-demand-support" as const },
    { label: t("businessCarePlans"), href: "/services/business-care-plans" as const },
  ];
          ...
          <div>
            ...
            <div className="space-y-3 text-xs text-white/70">
              <div className="flex gap-2">
                ...
                <div>
                  <p className="font-medium text-white">{t("dubaiUAE")}</p>
                  <p>{t("dubaiAddress")}</p>
                </div>
              </div>
              <div className="flex gap-2">
                <MapPin className="mt-0.5 h-4 w-4 flex-shrink-0 text-gold" />
                <div>
                  <p className="font-medium text-white">{t("india")}</p>
                  <p>{t("indiaAddress")}</p>
                </div>
              </div>
            </div>
